...
@section('body')
    ...
    <div class="gray-bg">
        ...
        <div class="container hsft">
            ...
            <img src="/img/1-150F2000I70-L.png" alt="">
            <h3 style="color: #00938F;font-size:1.9rem;font-weight: normal">汉斯福特</h3>
            <div class="row">
                <div class="col-md-8">
                    <p  style="color: #595959;font-family: 'Myriad W01 Lt', sans-serif;font-size: 12px;line-height: 30px">深圳市汉斯福特科技有限公司和深圳中南测控技术有限公司（面向高校和研究院，小规模纳税人）总部位于深圳，并在香港和武汉设有分公司。公司自成立以来始终专注于结构力学特性智能化测试技术，为数千家用户提供优质的测试系统解决方案，是国内领先的结构力学性能测试系统供应商。</p>
                </div>
        ...
        <ul>
            ...
            <li>
                <a href="{{action('Home\IndexController@detail',['band'=>$vo->band,'title'=>$vo->ename])}}">
                    ...
                    <p style="color:#005198">{{$vo->title}}</p>
                </a>
            </li>
                @endforeach
        </ul>
    ...
    <div class="gray-bg">
        <br><br>
        <div class="container hsft">
            <h3 style="color: #00938F;font-size:1.9rem;font-weight: normal;font-family: Arial">The International Business</h3>
            <br>
            <div class="row">
                <div class="col-md-3">
                    <img src="/img/sss.jpg" width="100%" alt="">
                </div>
                <div class="col-md-9">
                    <p  style="color: #595959;font-family: 'Myriad W01 Lt', sans-serif;font-size: 12px;line-height: 30px;font-family: Arial">Huntsort Technology offers a complete selection of force and measurement solutions including load cells, pressure sensors, vibration sensor, torque sensors, accelerometer and relative instruments such as indicators, controllers, junction box, transmitter and amplifier. We have deeply cooperation with factories of brands like HBM, Mettler Toledo, Vishay, Tedea, Celtron, Revere, Sartorius, Zemic, Keli and Precia molen. Most of those product lines are in stock.</p>
                    <a style="color: #595959;font-family: Arial" href="">International Website</a>
                </div>
            </div>
    ...
    <div class="gray-bg">
        <div class="container hsft-last">
            <ul>
                <li>
                    <h4 style="color: #00938f;"><i>售后合同</i></h4>
                    <a href="/list/34">
                        <img src="/img/1-150RG33112412.jpg" alt="">
                    </a>
                </li>
                <li>
                    <h4 style="color: #00938f;"><i>订单详情</i></h4>
                    <a href="/list/35">
                        <img src="/img/1-150RG33343136.png" alt="">
                    </a>
                </li>
                <li>
                    <h4 style="color: #00938f;"><i>下载中心</i></h4>
                    <a href="/list/38">
                        <img src="/img/1-150RG33535Y2.jpg" alt="">
                    </a>
                </li>
            </ul>
        </div>
...
@section("fis_resource")@parent @require('page/Home/index.blade.php')@stop
