<div class="navbar-wrapper">
    <div class="container">
        ...
        <a href="/" style='margin-left:-70px'><img style='margin-top:20px;width:40px;height:40px' src="/widget/layout/Home/hsft.png"></a>
        ...
        <p>
            ...
            <b><img src="/widget/layout/Home/gj.jpg" style="height:24px;width:24px" alt=""></b>&nbsp;&nbsp;|&nbsp;&nbsp;<b id="top-search">
                <img src="/widget/layout/Home/search.gif" style="height:22px;width:22px" alt="">
...
@section("fis_resource")@parent @require('widget/layout/Home/header.blade.php')@stop